    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            name: 'Blinkit Shipment Planning',
            href: '/reports/blinkit_shipment_planning',
            icon: Zap,
            requiredPermission: PERMISSION_REQUIREMENTS.BLINKIT_SHIPMENT_PLANNING,
          },
          {
            name: 'Blinkit Shipment Processing',
            href: '/reports/blinkit_shipment_processing',
            icon: Zap,
            requiredPermission: PERMISSION_REQUIREMENTS.BLINKIT_SHIPMENT_PROCESSING,
          },
        ],
      },
      {
